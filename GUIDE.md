...
| `REVIEW_ACCOUNTS` | тест-аккаунты для ревьюеров Google Play / App Store и демо-показов: `+998900000001:1234,...` — SMS не шлётся, вход по фиксированному коду. Код `*` вместо цифр = принимается любой непустой код. Прод: `+998 90 000 00 01` / `1234` (ревью) и `+998 93 523 60 60` / `*` (демо для партнёров) |
