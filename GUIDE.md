...
⚠️ **RLS сейчас ВЫКЛЮЧЕН на всех таблицах** — бэкенд ходит anon-ключом. Это дыра
безопасности (любой с anon-ключом читает/пишет всё). TODO: перевести бэкенд на
service-role ключ и включить RLS с политиками.
